...
EMBED_DIM = 100
SKIPGRAM_WINDOW = 5
SKIPGRAM_EPOCHS = 10          # Increased epochs for better convergence
SKIPGRAM_BATCH_SIZE = 131072  
SKIPGRAM_NEGATIVE_SAMPLES = 5
# Adam usually needs a slightly lower learning rate than SGD
SKIPGRAM_LEARNING_RATE = 0.001 
# With 32GB VRAM, you can likely remove this limit or set it much higher
SKIPGRAM_MAX_PAIRS = None
